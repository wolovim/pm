...
def handle_github_issue(issue_number: int, repo_name: str):
    ...
    if zoom_id:
        ...
        if existing_occurrence_index != -1:
            ...
            if str(new_topic_id).startswith("placeholder") and \
               existing_topic_id and not str(existing_topic_id).startswith("placeholder"):
            ...
            elif existing_topic_id and not str(existing_topic_id).startswith("placeholder") and \
                 new_topic_id and not str(new_topic_id).startswith("placeholder") and \
                 existing_topic_id != new_topic_id:
